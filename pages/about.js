  ...
  return (
    <section className="border-4 min-w-screen px-10 py-8  text-center sm:grid sm:grid-cols-2">
      ...
      <div className="text-left sm:col-start-1 ">
        ...
        <p className="text-lg lg:text-xl py-3">Having attended an immersive program for fullstack developement. Where I was trained and able to develope my skills further I feel ready to begin my professional journey.</p>
      </div>
